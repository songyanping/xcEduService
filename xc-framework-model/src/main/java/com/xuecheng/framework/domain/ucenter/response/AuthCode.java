...
public enum AuthCode implements ResultCode {
    ...
    AUTH_LOGIN_APPLYTOKEN_FAIL(false,23006,"申请令牌错误"),
    AUTH_LOGIN_APPLYTOKEN_ISNULL(false,23009,"申请令牌为空"),
    AUTH_LOGIN_TOKEN_SAVEFAIL(false,23008,"存储token错误"),
    AUTH_LOGIN_ERROR(false,23007,"登陆过程出现异常请尝试重新操作！");
